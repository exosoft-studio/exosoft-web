    ...
    <main className="text-2xl lg:text-3xl leading-relaxed ">
      <Section bgColor='bg-color2 text-color5' className='flex flex-col lg:justify-center items-center 
        lg:h-[700px] space-y-10'>
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-3 justify-center items-start">
      ...
      <Section id='entropi' bgColor='bg-color5 text-color2' className='flex flex-col lg:justify-center items-center 
        lg:h-[600px] lg:space-x-10 space-y-10'>
          ...
          <div className="flex flex-row container">
            <Button href="https://entropi.exosoft.studio" className="bg-color2 text-color5">Voir plus</Button>
          </div>
      </Section>
      <Section  id='stories' bgColor='bg-color2 text-color5' className='flex flex-col lg:justify-center items-center 
        lg:h-[600px] lg:space-x-10 space-y-10'>
          <div className="space-y-3">
          ...
          <div className="flex flex-row container">
            <Button href="https://stories.exosoft.studio" className="bg-color5 text-color2">Voir plus</Button>
          </div>
      </Section>
      <Section id='streams' bgColor='bg-color5 text-color2' className='flex flex-col lg:justify-center items-center 
        lg:h-[600px] lg:space-x-10 space-y-10'>
          <div className="space-y-3">
          ...
          <div className="flex flex-row container">
            <Button href="https://tropistreams.exosoft.studio" className="bg-color2 text-color5">Voir plus</Button>
          </div>
      </Section>
      <Section id='blog' bgColor='bg-color2 text-color5' className='flex flex-col lg:justify-center items-center 
        lg:h-[600px] lg:space-x-10 space-y-10'>
          <div className="space-y-3">
          ...
          <div className="flex flex-row container">
            <Button href="https://blog.exosoft.studio" className="bg-color5 text-color2">Voir plus</Button>
          </div>
      </Section>
